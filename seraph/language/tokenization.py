...
class SentimentAnalysis:
	...
	def __repr__(self) -> str:
		return "<seraph.language.tokenization.SentimentAnalysis of \"" + str(self) + "\", overall sentiment: " + reprReview(self.overall) + ">"
...
class TagGroup:
	...
	def __repr__(self) -> str:
		return "<seraph.language.tokenization.TagGroup of " + ", ".join(self) + ">"
...
class Tokenization(entity.Entity):
	...
	def __repr__(self) -> str:
		return "<seraph.language.tokenization.Tokenization of \"" + str(self) + "\">"
...
class Sentence:
    ...
    def __repr__(self) -> str:
        return "<seraph.language.tokenization.Sentence \"" + str(self) + "\">"
